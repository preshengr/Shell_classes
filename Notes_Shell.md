...
In manipulating files there are certain commnads that helps us gee those issues resolved; Commnads like: CP, MV , RM MKDIR
...
_These are meanings for basic commands used for manipulating files and directories.
*WILDCARDS*
